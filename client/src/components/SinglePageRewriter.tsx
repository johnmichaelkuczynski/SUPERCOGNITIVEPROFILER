...
import { FileText, Edit3, Loader2, Download, Share2 } from 'lucide-react';
...
interface SinglePageRewriterProps {
  isOpen: boolean;
  onClose: () => void;
  documentId: string;
  documentName: string;
...
export default function SinglePageRewriter({
  isOpen,
  onClose,
  documentId,
  documentName
}: SinglePageRewriterProps) {
