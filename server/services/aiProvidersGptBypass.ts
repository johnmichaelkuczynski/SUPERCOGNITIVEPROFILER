...
const PRESET_TEXT: Record<string,string> = {
  ...
  "Topic snap (early)": "Abruptly shift focus once, then return.",
  ...
  "Asymmetric emphasis (v2)": "Linger on the main claim; compress secondary points sharply.",
...
export class AIProviderService {
  ...
  // Get preset categories for organized UI
  getPresetCategories() {
    return {
      "Priority Techniques (1-8)": [
